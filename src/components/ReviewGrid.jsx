const ReviewGrid = () => {
  return (
    <div className="reviewGrid">
      <div className="left">
        <h1>SOUTHEAST FRENCH BULLDOG REVIEW</h1>
        <p>
          Below are reviews simply “cut and pasted” from our google, facebook
          and other reviews from our customers. We will try to update these
          every few months!
        </p>
        <p>Brenda “Lavenderenemy” Attardo</p>
        ...
        <p>
          Brian’s professionalism and dedication to his pups shined through
          every step of the process. Despite the distance between us and our pup
          (Florida to New Jersey), Brian made the entire experience seamless.
          His communication was prompt and informative, always keeping us in the
          loop.
        </p>
        <p>
          The highlight, of course, was welcoming our new fur baby into our
          home. She arrived safe and sound, thanks to the impeccable care
          provided by the puppy nanny. Not only is she absolutely stunning, but
          her temperament is a testament to the love and care she received from
          Brian and his team.
        </p>
        <p>
        ...
        <p>one month ago</p>
        <p>
          We bought a beautiful white fluffy. It was very easy process with
          communication and delivery of our dog.
        </p>
        <p>H. Hanlon</p>
        <div className="star">5 star</div>
        <p>Google review – 3 months ago</p>
        <p>
          I received my beautiful and sweet male platinum Frenchie this past
          Thursday (flown into Savannah with the awesome Melissa, the pet
          traveling nanny), and we are absolutely in love! He is PERFECT! Thank
          you Brian and Jen for raising such a beautifully structured high
          quality pup whose disposition is as sweet as he looks and for the
          continued assistance over text messaging as I get this little guy
