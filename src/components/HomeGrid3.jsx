    ...
    <div className="homeGrid3">
      <div className="left">
        ...
        <p>
          ...
          natus dolorem qui est laudantium reprehenderit necessitatibus
          blanditiis, nostrum ex iure saepe delectus, voluptas tempore a id, sed
          nobis veritatis aspernatur.
        </p>
      ...
      <div className="right">
        <img
          src="publicges/new-shade-rojo-french-bulldog-price-231-600x600.webp"
          alt=""
        />
        <img src="/es/Frenchie-breeders-6.jpg" alt="" />
      </div>
    </div>
  );
};
