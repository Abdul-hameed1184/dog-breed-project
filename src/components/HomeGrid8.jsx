    ...
    <div className="homeGrid8">
      <div className="left">
        ...
        <ul>
          ...
          <li>Isabella French Bulldog</li>
          <li>Rojo French bulldog</li>
          <li>Blue Frenchie Puppies</li>
          <li>Merle Frenchie</li>
          <li>Lilac Merle Frenchie</li>
          <li>Blue Merle Frenchie</li>
          <li>Isabella Merle French Bulldog</li>
          <li>Fluffy French Bulldog</li>
        </ul>
      </div>
      <div className="right">
